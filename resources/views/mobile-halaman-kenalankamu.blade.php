                  ...
                  <div class="self-stretch justify-start items-start inline-flex">
                    ...
                    <a href="halaman-kenalan" id="halamankenalan">
                      <div class="px-4 py-[9px] justify-center items-center gap-2 inline-flex">
                        <div class="text-black text-opacity-60 text-xs font-medium leading-normal tracking-tight">Semua Kenalan</div>
                      </div>
                    </a>
                    </div>
                    <div class="grow shrink basis-0 flex-col justify-center items-center inline-flex">
                    <a href="/kenalan-kamu" id="kenalankamu">
                      <div class="px-4 py-[9px] justify-center items-center gap-2 inline-flex">
                        <div class="text-sky-500 text-xs font-medium capitalize leading-normal tracking-tight">Kenalan Kamu</div>
                      </div>
                    </a>
