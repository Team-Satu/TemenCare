                  ...
                  <a href="/dashboard" class="flex items-center left-[20px] top-[30px] absolute ">
                    ...
                    <div class="overflow-x-auto flex flex-1 flex-col mt-2">
                        <div class="grid grid-cols-2 w-full">
                              <a href="/reports" class="col-span-1 text-center py-2" id="semua-laporan">
                                <h1 class=" text-xs poppins-medium leading-normal tracking-tight text-[#666666]">Semua
                                    Laporan</h1>
                              </a>
                              <a href ="" class="col-span-1 text-center py-2 border-[#2196F3] border-b-2" id="laporan-kamu">
                  ...
                  <i class="fa-solid fa-triangle-exclamation text-8xl justify-center items-center flex relative py-14" style="color: #f36464;"></i>
                    <div class="left-[62px] top-[178px] absolute">
                      ...
                      <div class="justify-center items-center gap-2 inline-flex">
                        ...
                        <a href="/your-reports" class="w-32 h-8 left-[216px] top-[248px] absolute bg-blue-300 rounded-3xl flex-col justify-center items-center inline-flex">
                          <div class="justify-center items-center gap-2 inline-flex">
