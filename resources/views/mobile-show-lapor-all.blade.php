...
<body class="bg-gray-100">
    <div class="max-w-md mx-auto h-screen">
        ...
        <div class="flex justify-between items-center mt-0 px-4">
            <div class="flex flex-col items-center">
                <button class="focus:outline-none" onclick="toggleActive('semua-laporan'); navigateTo('semua-laporan');">
            ...
            <div class="flex flex-col items-center">
                <button class="focus:outline-none" onclick="toggleActive('laporan-kamu'); navigateTo('laporan-kamu');">
                    <div id="laporan-kamu" class="text-neutral-600 text-xs font-medium capitalize leading-normal tracking-tight">
                        Laporan Kamu
                    </div>
                </button>
        ...
        <div class="profile-container" style="display: flex; flex-direction: column; align-items: flex-start; background: white; border-radius: 26px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 20px; width: 344px; height: auto; margin-bottom:20px; position: relative;">
          <div class="profile-header" style="display: flex; align-items: center; width: 100%; margin-bottom: 10px;">
            <img class="profile-image" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" 
            alt="holy" style="width: 48px; height: 48px; border-radius: 50%; margin-right: 16px;">
            <div class="profile-text">
              <p class="name" style="font-size: 14px; font-weight: medium; text-neutral-600; text-xs">H****</p>
          ...
          <div class="content-text">
            <p style="font-size: 14px; text-neutral-600;">Hati-hati di daerah Telkom depan gate 4, gua abis kena catcall </p>
          </div>
        </div>
    
        <div class="profile-container" style="display: flex; flex-direction: column; align-items: flex-start; 
        background: white; border-radius: 26px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 20px; width: 344px; height: auto; mt-20; margin-bottom: 20px;">
          <div class="profile-header" style="display: flex; align-items: center; width: 100%; margin-bottom: 10px;">
            <img class="profile-image" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" 
            alt="Leslie Alexander" style="width: 48px; height: 48px; border-radius: 50%; margin-right: 16px;">
            <div class="profile-text">
              <p class="name" style="font-size: 14px; font-weight: medium; text-neutral-600; text-xs">H****</p>
              <p class="mt-1 truncate text-xs leading-5 text-neutral-500">Baru Saja</p>
            </div>
        ...
        <button class="w-14 h-14 bg-blue-300 rounded-full shadow fixed" style="bottom: 20px; right: 20px; margin-right: 500px"onclick="togglePopup('block')">
          <img src="icon/addfilled.png" alt="add icon" class="w-6 h-6" style="margin-left: 15px;">
        </button>
        </div>

        <div id="popup" class="popup" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5);">
          <div class="popup-content" style="background-color: white; padding: 20px; position: relative; width: 30%;border-radius: 10px; margin: auto; margin-top: 15%;">
            <span id="closePopupBtn" class="close-btn" style="cursor: pointer; position: absolute; right: 20px; top: 10px; font-size: 24px;" onclick="togglePopup('none')">&times;</span>
            <p style="font-size: 18px;  position: absolute; left: 140px; top: 20px; font-weight: bold; text-neutral-600;">Tuliskan Laporanmu</p>
            <textarea placeholder="Tuliskan pengalamanmu di sini" style="width: 100%; padding: 10px; margin-top: 60px;"></textarea>
            <button style="background: #7EBAEB; border: none; color: white; padding: 10px 20px; 
    ...
    <div id="popupMenu" class="popup-menu" style="display: none; position: absolute; top: 150px; right: 600px; background: white; border-radius: 10px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.2); padding: 10px; z-index: 100; width: 150px;">
      <button style="background: none; border: none; color: red; padding: 10px; text-align: left; 
      width: 100%; cursor: pointer; border-radius: 5px; margin-bottom: 5px; font-size: 14px; " onclick="togglePopupConfirm('block')">Hapus Laporan
      </button>
      <button style="background: none; border: none; color: black; padding: 10px; text-align: left; 
      width: 100%; cursor: pointer; border-radius: 5px; font-size: 14px;" onclick="togglePopup('block')">Ubah Laporan
      </button>
    </div>
    ...
    <div id="popupConfirm" class="popup-menu" style="display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); background: white;
      ...
      <button style="background: skyblue; color: white; padding: 10px 20px; border: none; border-radius: 5px; margin-right: 10px; cursor: pointer; display: inline-block;">Yakin</button>
      <button style="background: grey; color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer; display: inline-block; margin: 10px 5px; "onclick="closePopup()">Kembali</button>
    </div>
