    ...
    <div class="row">
        <div class="col-xl-12 col-lg-7">
            <div class="card shadow mb-4">
                <form class="card-body" action="{{ route('admin.edit-community') }}" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Masukan deskripsi singkat komunitas Anda"
                            name="short_description" value="{{ $community->short_description }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="form-label">[Ganti] Gambar Komunitas</label>
