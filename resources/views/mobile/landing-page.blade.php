...
@section('content')
    ...
    <main class="bg-white">
        <section class="bg-gradient-to-br from-[#7FB4EC] to-[#C3DCEF] pt2">
            ...
            <div class="overflow-x-auto flex space-x-8 relative py-4 px-12 no-scrollbar">
                <div
                    ...
                    <div><span class="text-neutral-600 text-xs poppins-light">Sesi
                            konseling menggunakan </span><span class="text-neutral-600 text-xs poppins-medium">metode
